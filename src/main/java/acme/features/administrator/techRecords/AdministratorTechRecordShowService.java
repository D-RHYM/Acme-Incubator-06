...
@Service
public class AdministratorTechRecordShowService implements AbstractShowService<Administrator, TechRecord> {

	@Autowired
	private AdministratorTechRecordRepository repository;
