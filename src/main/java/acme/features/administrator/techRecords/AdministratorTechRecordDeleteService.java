...
@Service
public class AdministratorTechRecordDeleteService implements AbstractDeleteService<Administrator, TechRecord> {
	...
	@Override
	public void delete(final Request<TechRecord> request, final TechRecord entity) {
		assert request != null;
		assert entity != null;
